...
```
cd existing_repo
git remote add origin https://gitlab.com/AdeshM12/automation_scripts.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/AdeshM12/automation_scripts/-/settings/integrations)
